...
public enum EnumParametroSistema {
    ...
    DIRECCION_IMAGENES_USUARIOS("DIRECCION_IMAGENES_USUARIOS", "Dirección de imágenes de los usuarios dentro del sistema operativo", "/opt/sigc/config/usuarios", EnumGrupoParametroSistema.DATOS_SISTEMA, EnumTipoParametro.VALOR, null),
