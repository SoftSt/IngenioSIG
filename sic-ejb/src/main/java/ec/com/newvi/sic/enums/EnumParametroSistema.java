...
public enum EnumParametroSistema {
    ...
    DIRECCION_VISOR_PREDIOS("DIRECCION_VISOR_PREDIOS", "Dirección del visor de predios", "http://localhost/catvisor/?predio=", EnumGrupoParametroSistema.DATOS_SISTEMA, EnumTipoParametro.VALOR),
    DIRECCION_IMAGENES_SISTEMA("DIRECCION_IMAGENES_SISTEMA", "Dirección de imágenes del sistema", "/opt/sigc/config/imagenes", EnumGrupoParametroSistema.DATOS_SISTEMA, EnumTipoParametro.VALOR),
    DIRECCION_IMAGENES_PREDIO("DIRECCION_IMAGENES_PREDIO", "Dirección de imágenes de los predios dentro del sistema operativo", "/opt/sigc/imagenes/", EnumGrupoParametroSistema.DATOS_SISTEMA, EnumTipoParametro.VALOR),
    DIRECCION_SERVICIO_IMAGEN_PREDIO("DIRECCION_SERVICIO_IMAGEN_PREDIO", "Dirección del servicio para las imágenes del predio", "http://localhost:8080/geoserver/wms?LAYERS=nwi_catastro%3Abase_predios,nwi_catastro%3Aap031_via,nwi_catastro%3Ahe002_lote&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&STYLES=&FORMAT=image%2Fjpeg&SRS=EPSG%3A900913&WIDTH=533&HEIGHT=195&BBOX=", EnumGrupoParametroSistema.DATOS_SISTEMA, EnumTipoParametro.VALOR),
    RUTA_UBICACION_REPORTES("RUTA_UBICACION_REPORTES", "Ruta de ubicación de los reportes del sistema", "/opt/sigc/reportes/", EnumGrupoParametroSistema.DATOS_SISTEMA, EnumTipoParametro.VALOR),
