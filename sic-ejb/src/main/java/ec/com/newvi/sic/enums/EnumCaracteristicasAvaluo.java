...
public enum EnumCaracteristicasAvaluo {
    // PREDIO
    PREDIO_TERRENO_AREA("Area","S","valAreapredio", "", ""),
    ...
    PREDIO_TERRENO_AREA_CONSTRUCCION("Area de contruccion","N","valAreaconstruccion", "", ""),
    ...
    PREDIO_SERVICIOS_PROMEDIO_FACTORES("Servicios - Promedio de factores", "N", "", "", ""),
