...
public enum EnumNewviExcepciones {
    ...
    ERR348("ERR348", "Tenencia no válida.", "La tenencia ingresada no es válida. Por favor verifique que los datos ingresados son correctos."),
    ...
    INF363("INF363", "Avaluos ingresados.", "La lista de avaluos se han registrado correctamente."),
    INF364("INF364", "Tenencia ingresada.", "La tenencia se han registrado correctamente."),
    ...
    INF603("INF603", "Título dado de baja", "Se ha dado de baja el título correctamente."),
    ...
    INF606("INF606", "Título habilitado.", "El título se ha habilitado para el cobro con éxito."),
