...
public enum EnumReporte {
    ...
    LISTA_TITULOS_DESMARCADOS("LISTA_TITULOS_DESMARCADOS"),
    LISTA_TITULOS_DE_BAJA("LISTA_TITULOS_DESMARCADOS"),
    CARTERA_VENCIDA("CARTERA_VENCIDA"),
    DETALLE_COBROS_URBANO("DETALLE_COBROS_URBANO"),
    CERTIFICADO_USO_SUELO("CERTIFICADO_USO_SUELO"),;
