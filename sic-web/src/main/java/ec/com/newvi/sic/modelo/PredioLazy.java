 ...
 * @author Andrés
 */
public class PredioLazy extends LazyDataModel<FichaCatastralDto> {

    private List<FichaCatastralDto> listaFichaCatastralDtoFuente;

    public PredioLazy(List<FichaCatastralDto> listaFichaCatastralDtoFuente) {
