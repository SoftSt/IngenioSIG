...
public enum EnumEtiquetas {
    ...
    COBRO_TITULO_LISTA_TITULO("Cobro de Títulos por Predio"),
    COBRO_TITULO_LISTA_ICONO("fa fa-money"),
    COBRO_TITULO_LISTA_DESCRIPCION("Adición de nuevos elementos al predio"),
    COBRO_TITULO_EDITAR_TITULO("Acciones sobre los títulos"),
    COBRO_TITULO_EDITAR_ICONO("fa fa-bolt"),
    COBRO_TITULO_EDITAR_DESCRIPCION("Se podrá incluir excepcions, cobros"),
