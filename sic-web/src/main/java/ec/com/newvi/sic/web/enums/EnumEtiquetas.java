...
public enum EnumEtiquetas {
    ...
    GENERARION_TITULO_LISTA_TITULO("Nuevos Títulos"),
    GENERARION_TITULO_LISTA_ICONO("fa fa-plus"),
    GENERARION_TITULO_LISTA_DESCRIPCION("Generación de títulos"),
    GESTION_TITULO_LISTA_TITULO("Títulos"),
    GESTION_TITULO_LISTA_ICONO("fa fa-list-alt"),
    GESTION_TITULO_LISTA_DESCRIPCION("Gestión de títulos"),
