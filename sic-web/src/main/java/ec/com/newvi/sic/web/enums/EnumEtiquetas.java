...
public enum EnumEtiquetas {
    ...
    FICHA_CATASTRAL_LISTA_RURAL_EDITAR_TITULO("Lista de Fichas Prediales Rurales"),
    FICHA_CATASTRAL_LISTA_RURAL_EDITAR_ICONO("fa fa-edit"),
    FICHA_CATASTRAL_LISTA_RURAL_EDITAR_DESCRIPCION("Edición de Fichas Rurales."),
