...
public enum EnumEtiquetas {
    ...
    NUEVOS_ELEMENTOS_PREDIO_EDITAR_TITULO("Selección Predios"),
    NUEVOS_ELEMENTOS_PREDIO_EDITAR_ICONO("fa fa-check-square-o"),
    NUEVOS_ELEMENTOS_PREDIO_EDITAR_DESCRIPCION("Se incluirá los siguientes cambios a los predios que se seleccione"),
