...
public enum EnumEtiquetas {
    ...
    FICHA_CATASTRAL_LISTA_TITULO("Lista de Fichas Prediales "),
    FICHA_CATASTRAL_LISTA_ICONO("fa fa-list-alt"),
    FICHA_CATASTRAL_LISTA_DESCRIPCION("Gestión de fichas prediales."),
    ...
    PROPIETARIO_LISTA_ICONO("fa fa-building"),
    PROPIETARIO_LISTA_DESCRIPCION("Lista de predios con su contribuyente."),
    ...
    CALCULAR_AVALUO_LISTA_TITULO("Cálculo de Avalúos"),
    CALCULAR_AVALUO_LISTA_ICONO("fa fa-laptop"),
    CALCULAR_AVALUO_LISTA_DESCRIPCION("Cálculo, generación y consulta de avalúos catastrales"),
    GENERACION_TITULO_LISTA_TITULO("Nuevos Títulos"),
    GENERACION_TITULO_LISTA_ICONO("fa fa-plus"),
    GENERACION_TITULO_LISTA_DESCRIPCION("Generación de títulos"),
    ...
    PARAMETROS_LISTA_TITULO("Parámetros para calculo"),
    PARAMETROS_LISTA_ICONO("fa fa-calculator"),
    PARAMETROS_LISTA_DESCRIPCION("Gestión de parámetros."),
    PARAMETROS_NUEVO_TITULO("Nuevo Parámetro"),
    PARAMETROS_NUEVO_ICONO("fa fa-plus"),
    PARAMETROS_NUEVO_DESCRIPCION("Creación de nuevo Parámetro."),
    PARAMETROS_EDITAR_TITULO("Editar Parámetro"),
    PARAMETROS_EDITAR_ICONO("fa fa-edit"),
    PARAMETROS_EDITAR_DESCRIPCION("Edición del Parámetro seleccionado."),
