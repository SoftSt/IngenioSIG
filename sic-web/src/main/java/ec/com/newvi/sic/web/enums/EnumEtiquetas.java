...
public enum EnumEtiquetas {
    ...
    NUEVOS_ELEMENTOS_PREDIO_LISTA_ICONO("fa fa-pencil-square-o"),
    ...
    NUEVOS_ELEMENTOS_PREDIO_EDITAR_ICONO("fa fa-pencil-square-o"),
    NUEVOS_ELEMENTOS_PREDIO_EDITAR_DESCRIPCION("Seleccionar predios a modificarse"),
