...
public enum EnumEtiquetas {
    ...
    COBRO_TITULO_LISTA_TITULO("Selección de Títulos por Predio"),
    COBRO_TITULO_LISTA_ICONO("fa fa-check-square-o"),
    COBRO_TITULO_LISTA_DESCRIPCION("Se desplegará la información del Predio y sus Títulos"),
    COBRO_TITULO_EDITAR_TITULO("Cobro de Títulos del Predio"),
    COBRO_TITULO_EDITAR_ICONO("fa fa-money"),
    COBRO_TITULO_EDITAR_DESCRIPCION("Se realizará el cobro de los Títulos del Predio"),
